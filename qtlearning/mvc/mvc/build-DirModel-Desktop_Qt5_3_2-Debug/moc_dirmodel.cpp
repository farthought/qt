...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DirModel_t, stringdata) + ofs \
...
const QMetaObject DirModel::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DirModel.data,
      qt_meta_data_DirModel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DirModel.stringdata))
