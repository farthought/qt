...
#include "../booleanparser/booleanwindow.h"
...
struct qt_meta_stringdata_BooleanWindow_t {
    QByteArrayData data[4];
    char stringdata[45];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_BooleanWindow_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_BooleanWindow_t qt_meta_stringdata_BooleanWindow = {
    {
...
QT_MOC_LITERAL(3, 40, 4)
    ...
    "BooleanWindow\0booleanExpressionChanged\0"
    "\0expr"
};
...
const QMetaObject BooleanWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_BooleanWindow.data,
      qt_meta_data_BooleanWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BooleanWindow.stringdata))
